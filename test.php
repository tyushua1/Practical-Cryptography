...
<body>
  <script>
  	...
  	if($_SESSION['username'] == null){
		?>
        <script language="JavaScript"> alert("匿名用户禁止上传文件"); location.href="test.html"; </script> 
        <?php
        }?>
  </script>
...
{
   $file="$stored_path".$_FILES['file'];
   $file = fopen($_FILES['file']['name'], "r+") or die("Unable to open file!");  
